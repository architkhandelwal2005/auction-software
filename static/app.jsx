...
const SPORT_TEMPLATE_OPTIONS = {
    cricket:    [{id:'arena',label:'Arena Portrait'},{id:'ck-crease',label:'Crease — Aerial Ground'},{id:'ck-house',label:'Full House — Packed Stand'},{id:'ck-nets',label:'Nets — Practice Nets'}],
